...
import ale_experiment_saver
import ale_agent_saver
import q_network
...
def process_args(args, defaults, description):
    ...
    parser.add_argument('-o', '--out_file', dest="out_file", default=defaults.OUT_FILE,
                        help='Frame output pickle file(default: %(default)s)')
...
def launch(args, defaults, description):
    ...
    agent = ale_agent_saver.NeuralAgent(network,
    ...
    experiment = ale_experiment_saver.ALEExperiment(ale, agent,
                                              defaults.RESIZED_WIDTH,
                                              defaults.RESIZED_HEIGHT,frames_list,
    ...
    experiment.run()
    with open(parameters.out_file,'w') as frames_out_file :
        cPickle.dump(frames_list,frames_out_file)
    frames_out_file.close()
