...
class ALEExperiment(object):
    def __init__(self, ale, agent, resized_width, resized_height, frame_out_list,
        ...
        self.frame_storage = frame_out_list
    ...
    def get_observation(self):
        ...
        max_image_color = np.maximum(self.screen_buffer_color[index, ...],
                               self.screen_buffer_color[index - 1, ...])
        obs_frame_color = self.resize_image(max_image_color)
        obs_frame = self.resize_image(max_image)
        self.frame_storage.append(obs_frame_color)
        return obs_frame
